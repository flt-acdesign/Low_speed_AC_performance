...
md" Wing area in *m^2* (**Sw**) =  $(@bind Sw NumberField(1:1:1000, default=18.2))     ······Aircraft maximum lift coefficient (**CLmax**) =  $(@bind CLmax NumberField(0.1:.1:7, default=1.2))      "

# ╔═╡ de07547d-4c70-4793-96f2-8dfb2379ac54
md" Aircraft mass in *kg* (**M**) =  $(@bind Mass NumberField(0.0:10:600000, default=650)) ······ **CD0** =  $(@bind CD0 NumberField(0.0:.005:.1, default=.014))   "
...
md" **e** =  $(@bind Oswald NumberField(0.1:.01:1.5, default=.7)) ······ **Aspect Ratio** =  $(@bind AR NumberField(1:.1:30, default=13.8))  "
...
manifest_format = "2.0"
project_hash = "a802a681ec13c1fa9d5369c992b3a7d47d6a2967"
